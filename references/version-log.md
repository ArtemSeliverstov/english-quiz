...
- **Записано**: exercises `error_correction` 8/9 rich (`players/nicole_ru/exercises/1787824514939`, streak bumped 27.08; поле date поправлено 26→27 через MCP — лог-скрипт получил вчерашнюю дату из продолжающейся сессии). Инвентарь: «дефиз» ×4 в блоке (встречи 7–10, один инлайн с проверкой «дефиса»). Осталось из плана: 2 правила пунктуации · числительные-разряды · mock 2 форма B (бумага) 30–31.08.
