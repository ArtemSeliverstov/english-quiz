# Version Log — pre-2026-05-09 sessions

Archived 2026-05-11 from references/version-log.md as part of the plans/ + references/ restructure. Sessions from 2026-05-08 r3 back to the start of the t-series ladder. The live version-log.md keeps the last 5 sessions only; consult that first.

Format and entry conventions match the live log.
