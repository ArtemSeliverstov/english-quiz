...
| `ru_ne` | 15 | RU: НЕ с частями речи | RU track W2 Ники — детекторы НЕ (глагол / без НЕ не живёт / синоним / спор «, а» / «но»); пробник квиза 08–15.09; same ruTrack gate |
| `ru_mt` | 36 | RU: Математические термины | Терм-канал math-track (`plans/math-track-nicole.md` §терм-дорожка) — same ruTrack gate; ✅ в ru_terms только по производству в CC-сессиях |
