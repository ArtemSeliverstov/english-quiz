...
| `speaking-practice-ux.md` | **Proposal, 2026-09-11.** Speaking practice without file shuffling: PWA Free Speak (mic on Free Write + spoken reply, Anna first, iOS home-screen recording test as go/no-go) → Telegram voice bot after a 4–6 week engagement gate; `interview_prep` moves into the same flow. STT stays Whisper-turbo and returns its word timestamps; nova-3 fillers for interview mode; Azure PA + real-time voice deferred with triggers. | none — awaiting Artem's go |
...
| `school-adaptation-ernest.md` | **Культурный бриф + беседы Б1–Б4 и микрослои** к старту 10 класса Tamos: рамка «два регистра» (Cambridge-поток / госстандарт-блок), негласные правила класса, красные линии с историческим слоем (ашаршылық → Желтоксан → Қаңтар → Жаңа Қазақстан: Конституция-2026, парламент-Курултай, олигархи через IGCSE-экономику + сюжеты с карты города, Нацфонд-детям, АЭС/ИИ), казахский декодер-слой, смолл-ток, интровертная тактика. Анти-перегруз: до школы одна беседа; рулевой контур «глубже/дальше» + карта интереса 🔥🙂💤 + парковка вопросов. | none — CC ведёт беседы, триггер «это Эрнест, культурная беседа» |
